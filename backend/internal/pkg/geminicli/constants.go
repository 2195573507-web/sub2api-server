...
const (
	...
	GeminiCLIOAuthClientID     = "YOUR_GEMINI_CLI_GOOGLE_CLIENT_ID.apps.googleusercontent.com"
	GeminiCLIOAuthClientSecret = "" // set via GEMINI_CLI_OAUTH_CLIENT_SECRET env var
